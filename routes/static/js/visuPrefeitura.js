function voltar() {
    window.location.replace('http://127.0.0.1:5000/prefeitura.html');
}
function voltarParaIndex() {
    window.location.replace('http://127.0.0.1:5000/TelaInicial.html');
}
function visuBeneficiado() {
    window.location.replace('http://127.0.0.1:5000/escolhaP');
}
